//
//  CONINVITEInviteEventViewController.h
//  Invite-A-Friend
//
...
@interface CONINVITEInviteEventViewController : UIViewController <UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource>{
    NSArray *tweets;
    NSArray *friends;
