//
//  CONINVITEListFollowersViewController.h
//  Invite-A-Friend
//
...
@interface CONINVITEListFollowersViewController : UIViewController <UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource>{
    NSArray *tweets;
    NSArray *friends;
