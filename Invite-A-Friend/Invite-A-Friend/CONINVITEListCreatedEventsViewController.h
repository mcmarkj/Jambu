//
//  CONINVITEListCreatedEventsViewController.h
//  Invite-A-Friend
//
...
@interface CONINVITEListCreatedEventsViewController : UIViewController <UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource>{
    NSArray *tweets;
    NSArray *friends;
