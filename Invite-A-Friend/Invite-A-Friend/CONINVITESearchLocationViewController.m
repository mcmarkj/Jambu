//
//  CONINVITESearchLocationViewController.m
//  Invite-A-Friend
//
...
#import "CONINVITESearchLocationViewController.h"
#import <QuartzCore/QuartzCore.h>
#import "JSON.h"
#include "CustomFriendCells.h"
#include "EventListCell.h"

@interface CONINVITESearchLocationViewController ()
- (IBAction)closeView:(id)sender;
@end
CLLocationManager *locationManager;

@implementation CONINVITESearchLocationViewController
@synthesize tweets;
@synthesize friends;
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar{
    ...
    NSString *searchType = self.searchBar.text;
    float latitude = locationManager.location.coordinate.latitude;
    float longitude = locationManager.location.coordinate.longitude;
    
    NSMutableString *searchString = [NSMutableString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/textsearch/json?location=%f,%f&radius=500&query=%@&sensor=true&key=AIzaSyA1Lhquy0i_IsHtKBxfSCZOJTlNnMNfb20",latitude, longitude, searchType];
...
- (void)viewDidLoad
{
   ...
   // NSString *UID = [defaults objectForKey:@"Con96TUID"];
         ...
         NSMutableString *searchString = [NSMutableString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/textsearch/json?query=%@&sensor=true&key=AIzaSyA1Lhquy0i_IsHtKBxfSCZOJTlNnMNfb20",@"Belfast%20Castle"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.eventName.text = [[tweets objectAtIndex:[indexPath row]] objectForKey:@"name"];
    ...
    NSString * timeStampString = [NSString stringWithFormat:@"%@",[[tweets objectAtIndex:indexPath.row] objectForKey:@"formatted_address"]];
    cell.eventTime.text = timeStampString;
    ...
    float latitude1 = [[[geog objectAtIndex:indexPath.row] objectForKey:@"lat"] floatValue];
    float long1 = [[[geog objectAtIndex:indexPath.row] objectForKey:@"lng"] floatValue];
