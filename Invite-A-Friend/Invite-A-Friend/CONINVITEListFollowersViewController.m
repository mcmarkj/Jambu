//
//  CONINVITEListFollowersViewController.m
//  Invite-A-Friend
//
//  Created by Mark McWhirter on 01/03/2014.
//  Copyright (c) 2014 Concept96. All rights reserved.
//

#import "CONINVITEListFollowersViewController.h"
...
@implementation CONINVITEListFollowersViewController
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar{
    ...
    NSMutableString *searchString = [NSMutableString stringWithFormat:@"http://amber.concept96.co.uk/api/v1/followers/%@",@""];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
	...
	NSArray *allTweets = [results objectForKey:@"followers"];
...
- (void)viewDidLoad
{
    ...
    NSMutableString *searchString = [NSMutableString stringWithFormat:@"http://amber.concept96.co.uk/api/v1/followers/%@",UID];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:searchString]];
    [NSURLConnection connectionWithRequest:request delegate:self];
    [self.searchBar resignFirstResponder];
