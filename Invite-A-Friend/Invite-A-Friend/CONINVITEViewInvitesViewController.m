//
//  CONINVITEViewInvitesViewController.m
//  Invite-A-Friend
//
...
#import "CONINVITEViewInvitesViewController.h"
...
- (void)viewDidLoad
{
    ...
    NSMutableString *searchString = [NSMutableString stringWithFormat:@"http://amber.concept96.co.uk/api/v1/pending_events/%@/",UID];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:searchString]];
    [NSURLConnection connectionWithRequest:request delegate:self];
    [self.searchBar resignFirstResponder];
